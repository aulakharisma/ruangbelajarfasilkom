        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url() ?>dashboard_admin/users" class="nav-link">
                  <i class="fa-solid fa-users"></i>
                  <p>Users</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url() ?>dashboard_admin/materi" class="nav-link">
                  <i class="fa-solid fa-file"></i>
                  <p>Materi</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url() ?>dashboard_admin/matkul" class="nav-link">
                  <i class="fa-solid fa-book"></i>
                  <p>Kategori Matkul</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url() ?>dashboard_admin/registrasi" class="nav-link">
